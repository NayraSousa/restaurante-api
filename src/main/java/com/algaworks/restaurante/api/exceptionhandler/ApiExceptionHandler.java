...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
			...
			Problema problema = createProblemBuilder((HttpStatus)status, problemType, detail)
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String detail = "O corpo da requisição está inválido. Verifique erros de sintaxe, tipos inválidos ou de corpo vazio";
		
		Problema problema = createProblemBuilder((HttpStatus) status, problemType, detail).build();
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, 
	    ...
	    Problema problem = createProblemBuilder((HttpStatus)status, problemType, detail).build();
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
		...
		String detail = String.format("O campo %s é inválido, retire-o para continuar", path);
