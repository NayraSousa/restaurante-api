...
insert into estado (id, nome) values (2, 'Brasília');

insert into cidade (id, nome, estado_id) values (1, 'Fortaleza', 1);
insert into cidade (id, nome, estado_id) values (2, 'Caucaia', 1);
insert into cidade (id, nome, estado_id) values (3, 'Uberlândia', 2);

insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (1, 'MareSol', 10, 1, utc_timestamp, utc_timestamp, 1, '38400-999', 'Rua João Pinheiro', '1320', 'Jardim');
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (2, 'Tô com fome', 0, 2, utc_timestamp, utc_timestamp, 2, '23454-000', 'rua linda', '45', 'cigana');
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (3, 'Mare Café', 9.75, 2, utc_timestamp, utc_timestamp, 1, '3534', 'rua 3', '2', 'plan');
